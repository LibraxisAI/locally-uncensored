    ...
    details: [
      {
        ...
        items: [
          ...
          'The Memory sources chip under every AI answer is gone; the purple brain icon in the session strip below the transcript, right above the composer, still opens Memory.',
        ],
      },
    ],
  },
