    ...
    details: [
      {
        ...
        items: [
          ...
          'Setting an install location for the Character Trainer now also redirects pip, Hugging Face and torch\'s own caches there, so moving the trainer off a small system drive keeps those caches off it too.',
