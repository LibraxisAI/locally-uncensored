...
describe('discover — data validation', () => {
  ...
  describe('COMPONENT_REGISTRY', () => {
    it('has entries for all expected model types', () => {
      const expectedTypes = [
        'sd15', 'sdxl', 'flux', 'flux2', 'zimage', 'ernie_image', 'qwenimage', 'wan', 'hunyuan',
    ...
    it('UNET-based types that need separate VAE have vae spec with downloadUrl', () => {
      const typesWithVAE = ['flux', 'flux2', 'zimage', 'ernie_image', 'qwenimage', 'wan', 'hunyuan', 'mochi', 'cosmos', 'cogvideo', 'framepack', 'pyramidflow']
    ...
    it('UNET-based types that need separate CLIP have clip spec with downloadUrl', () => {
      const typesWithCLIP = ['flux', 'flux2', 'zimage', 'ernie_image', 'qwenimage', 'wan', 'hunyuan', 'ltx', 'mochi', 'cosmos', 'cogvideo', 'framepack']
