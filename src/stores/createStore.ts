...
export const MODEL_TYPE_DEFAULTS: Record<ModelType, {
  ...
  // K9 (GH #136): mirrors comfyui.ts's MODEL_TYPE_DEFAULTS.krea2 (author
  // workflow: euler, CFG 1, 8 steps, 1024x1024).
  krea2:       { steps: 8,  cfgScale: 1.0, sampler: 'euler',           scheduler: 'simple', width: 1024, height: 1024 },
